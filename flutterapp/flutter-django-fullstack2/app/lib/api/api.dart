...
class TodoProvider with ChangeNotifier {
  ...
  void addTodo(Todo todo) async {
    final response = await http.post('https://gorest.co.in/public/v2/todos/',
        headers: {"Content-Type": "application/json","Access-Control-Allow-Origin:":"*"}, body: json.encode(todo));
